            ...
            <!-- Navbar Right Menu -->
              <div class="navbar-custom-menu">
                ...
                <li class="">
                  ...
                  <!-- Tasks Menu -->
                    <!-- Menu Toggle Button -->
                   <a href="home.php" class="" style="font-size:14px"><i class="glyphicon glyphicon-star-empty"></i> Feedback</a>
                  </li>
                  <!-- Tasks Menu -->
                 <li class="">
                    <!-- Menu Toggle Button -->
                   <a href="home.php" class="" style="font-size:14px"><i class="glyphicon glyphicon-star-empty"></i> Class Routine</a>
                  </li>
                      ...
                      <li>
                        ...
                        <ul class="menu">
						  <li><!-- start notification -->
                            <a href="class.php">
                              <i class="glyphicon glyphicon-user text-green"></i> Batch
                            </a>
                          </li><!-- end notification -->
              ...
              <li><!-- start notification -->
						  ...
						  <li><!-- start notification -->
                            <a href="sy.php">
                              <i class="glyphicon glyphicon-user text-green"></i> University Year
                            </a>
                          </li><!-- end notification -->
